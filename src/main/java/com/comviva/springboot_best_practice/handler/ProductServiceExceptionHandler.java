package com.comviva.springboot_best_practice.handler;


import com.comviva.springboot_best_practice.dto.APIResponse;
import com.comviva.springboot_best_practice.dto.ErrorDTO;
...
public class ProductServiceExceptionHandler {
    ...
    public APIResponse<?> handleMethodArgumentException(MethodArgumentNotValidException exception) {
        ...
        serviceResponse.setErrorList(errors);
    ...
    public APIResponse<?> handleServiceException(ProductServiceBusinessException exception) {
        APIResponse<?> serviceResponse = new APIResponse<>();
        serviceResponse.setStatus("FAILED");
        serviceResponse.setErrorList(Collections.singletonList(new ErrorDTO("", exception.getMessage())));
        return serviceResponse;
    }
